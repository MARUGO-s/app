/**
 * 全レシピのカテゴリーを Gemini で案Aに一括変換（サービスロールキー必須）
 *
 * 使い方:
 *   SUPABASE_URL=https://xxx.supabase.co \
 *   SUPABASE_SERVICE_ROLE_KEY=eyJ... \
 *   node scripts/classify-recipe-categories.mjs
 *
 * ドライラン:
 *   ... node scripts/classify-recipe-categories.mjs --dry-run
 */
...
const endpoint = `${SUPABASE_URL.replace(/\/$/, '')}/functions/v1/classify-recipe-categories`;
