...
.composite-cost-page__search-card {
  --card-accent: #f97316;
  --card-tint: rgba(249, 115, 22, 0.08);
  appearance: none;
...
.composite-cost-page__search-card--selected {
  border-color: #f97316;
  box-shadow: 0 0 0 2px rgba(249, 115, 22, 0.18), 0 12px 26px rgba(249, 115, 22, 0.18);
  background: #fff7ed;
}
...
.composite-cost-page__search-card--tone-2 {
  --card-accent: #0f766e;
  --card-tint: rgba(15, 118, 110, 0.08);
}
...
.composite-cost-page__search-card--tone-4 {
  --card-accent: #8b5e34;
  --card-tint: rgba(139, 94, 52, 0.1);
}

.composite-cost-page__search-card--tone-5 {
  --card-accent: #be123c;
  --card-tint: rgba(190, 18, 60, 0.08);
}
