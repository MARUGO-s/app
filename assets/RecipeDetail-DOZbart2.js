...
.base-item-label:hover {
    background: #f8f9fa;
    border-color: #adb5bd;
}

.base-item-control input[type="radio"]:checked + .base-item-label {
...
.ingredient-group-heading__button {
    width: 100%;
    display: flex;
    align-items: center;
    justify-content: space-between;
...
.ingredient-group-heading__button:focus-visible {
    outline: 2px solid hsl(var(--color-primary));
    outline-offset: 4px;
    border-radius: 6px;
}

.ingredient-group-heading__title {
    flex: 1 1 180px;
    min-width: 0;
}

.ingredient-group-heading__meta {
    display: inline-flex;
    align-items: center;
    justify-content: flex-end;
    gap: 8px;
...
.ingredient-group-heading__hint {
    flex-shrink: 0;
    padding: 4px 10px;
    border-radius: 999px;
...
.ingredient-group-heading--hidden {
    display: none;
}
...
.group-stats-card--wide {
    grid-column: 1 / -1;
}

.group-stats-card__label {
    font-size: 0.84rem;
    font-weight: 700;
    color: #6b7280;
}

.group-stats-card__value {
    font-size: 1.12rem;
    font-weight: 800;
    color: #111827;
    line-height: 1.3;
...
.group-usage-simulator__header {
    display: flex;
    flex-direction: column;
    gap: 6px;
}

.group-usage-simulator__title {
    margin: 0;
    font-size: 1rem;
    font-weight: 800;
    color: #111827;
...
.group-usage-simulator__desc,
.group-usage-simulator__notes p {
    margin: 0;
    font-size: 0.92rem;
    line-height: 1.6;
    color: #4b5563;
...
.group-usage-simulator__controls {
    display: grid;
    grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));
    gap: 12px;
}

.group-usage-simulator__field {
    display: flex;
    flex-direction: column;
    gap: 8px;
}

.group-usage-simulator__label {
    font-size: 0.84rem;
    font-weight: 700;
    color: #6b7280;
}

.group-usage-simulator__input-row {
    display: flex;
    align-items: center;
    gap: 8px;
}

.group-usage-simulator__input-row input,
.group-usage-simulator__input-row select {
    height: 42px;
    border: 1px solid #d1d5db;
    border-radius: 10px;
    padding: 0 12px;
...
.group-usage-simulator__unit-pill {
    min-width: 88px;
    height: 42px;
    display: inline-flex;
    align-items: center;
...
.group-usage-simulator__results {
    display: grid;
    grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));
    gap: 12px;
}

.group-usage-simulator__result-card {
    display: flex;
    flex-direction: column;
    gap: 8px;
    padding: 16px;
...
.group-usage-simulator__result-card--accent {
    background: rgba(255, 140, 0, 0.08);
    border-color: rgba(255, 140, 0, 0.24);
}

.group-usage-simulator__result-label {
    font-size: 0.84rem;
    font-weight: 700;
    color: #6b7280;
}

.group-usage-simulator__result-value {
    font-size: 1.22rem;
    line-height: 1.3;
    font-weight: 800;
    color: #111827;
