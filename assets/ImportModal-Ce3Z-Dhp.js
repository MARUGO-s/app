...
.image-target-btn.active {
    border-color: #2563eb;
    background: #eff6ff;
    color: #1d4ed8;
}

.image-target-btn-bread.active {
    border-color: #d97706;
    background: #fff7ed;
    color: #b45309;
}

.image-target-btn:disabled {
    opacity: 0.6;
    cursor: not-allowed;
}
...
.pdf-upload-wrapper.drag-active {
    border-color: var(--color-primary);
    background: #f0f9ff;
}

.pdf-upload-wrapper.drag-active .pdf-upload-label {
    color: var(--color-primary);
    font-weight: 600;
}
...
.pdf-recipe-preview-item:last-child {
    border-bottom: none;
}
...
.import-modal-card.pdf-preview-mode {
    max-width: 560px;
}
`;export{n as default};
