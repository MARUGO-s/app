...
.recipe-form-mock .recipe-form-mock__card--ai.glass-card {
    --card-accent: #38bdf8;
    --card-accent-ring: rgba(56, 189, 248, 0.20);
    background: linear-gradient(180deg, rgba(14, 165, 233, 0.16), var(--mock-surface));
    border-color: rgba(56, 189, 248, 0.28);
}

.recipe-form-mock .recipe-ai-form {
    display: flex;
    flex-direction: column;
    gap: 12px;
}

.recipe-form-mock .recipe-ai-form__label {
    display: flex;
    flex-direction: column;
    gap: 6px;
    color: var(--mock-muted);
...
.recipe-form-mock .recipe-ai-form__input,
.recipe-form-mock .recipe-ai-form__select,
.recipe-form-mock .recipe-ai-form__textarea {
    width: 100%;
...
.recipe-form-mock .recipe-ai-form__input:focus,
.recipe-form-mock .recipe-ai-form__select:focus,
.recipe-form-mock .recipe-ai-form__textarea:focus {
    border-color: #38bdf8;
    box-shadow: 0 0 0 4px rgba(56, 189, 248, 0.18), inset 0 1px 0 rgba(255, 255, 255, 0.08);
}

.recipe-form-mock .recipe-ai-form__error {
...
.recipe-form-mock .recipe-ai-form__result {
...
.recipe-form-mock .recipe-ai-form__result ul {
    margin: 8px 0 0;
...
.recipe-form-mock .recipe-ai-form__agents,
.recipe-form-mock .recipe-ai-form__sources {
...
.recipe-form-mock .recipe-ai-agent-line {
    display: grid;
...
.recipe-form-mock .recipe-ai-agent-line b {
    color: var(--mock-text);
}

.recipe-form-mock .recipe-ai-agent-line p {
    margin: 3px 0 0;
    color: var(--mock-muted);
    line-height: 1.5;
...
.recipe-form-mock .recipe-ai-form__sources a {
    color: #bae6fd;
    text-decoration: none;
    line-height: 1.35;
}

.recipe-form-mock .recipe-ai-form__sources a:hover {
    text-decoration: underline;
}

.recipe-form-mock .recipe-ai-form__conversation {
    display: grid;
    gap: 10px;
...
.recipe-form-mock .recipe-ai-form__conversation-messages {
    display: grid;
    gap: 8px;
    max-height: 220px;
    overflow: auto;
...
.recipe-form-mock .recipe-ai-form__conversation-message {
    display: grid;
    grid-template-columns: 42px 1fr;
    gap: 7px;
}

.recipe-form-mock .recipe-ai-form__conversation-message span {
    border-radius: 999px;
    padding: 3px 6px;
    text-align: center;
    font-size: 0.68rem;
...
.recipe-form-mock .recipe-ai-form__conversation-message--user span {
    background: rgba(255, 255, 255, 0.16);
    color: var(--mock-text);
}

.recipe-form-mock .recipe-ai-form__conversation-message--assistant span {
    background: rgba(56, 189, 248, 0.18);
    color: #bae6fd;
}

.recipe-form-mock .recipe-ai-form__conversation-message p {
    margin: 0;
