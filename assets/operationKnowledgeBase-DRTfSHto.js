...
const CORE_OPERATION_KB = [
    ...
    },
    {
        ...
        keywords: ['コスト率', '利益', '利益額', '利益計算', '売値', '原価率', '利益率', 'food cost', 'フードコスト', '売値入力', '税率', 'コスト率 高い', 'コスト率 赤'],
        views: ['composite-cost', 'composite-cost-edit'],
        steps: [
            '合成原価画面の下部「利益計算」エリアを開きます。',
            '「売値（税込）」と税率（8% or 10%）を入力します。',
            '利益額 = 売値（税抜）− 合計原価 が自動計算されます。',
            'コスト率 = 合計原価 ÷ 売値（税抜）× 100（%）が表示されます。',
            'コスト率が高い（利益が出にくい）場合は赤系の色で表示されます。'
        ],
        notes: '目安としてフードコスト率30〜35%が一般的な飲食店の目標値です。コスト率が高い場合は使用量を見直すか、売値の調整を検討してください。'
    },
    {
        id: 'composite_cost_saved_list',
        title: '保存済み合成レシピの一覧・編集・削除',
        keywords: ['合成レシピ 保存一覧', '保存済み 合成', '合成 一覧', '合成 編集', '合成 削除', '保存済み合成レシピ', '合成原価 開く', '合成原価 編集', '合成原価 保存一覧', '一覧 クリック'],
        views: ['composite-cost-saved', 'composite-cost-edit'],
        steps: [
            'メニューの「📚 合成レシピ保存一覧」を開きます。',
            '保存済みの合成レシピが一覧で表示されます（料理名・合成原価・更新日時）。',
...
const SYNONYM_GROUPS = [
    ...
    ['コスト率', '利益', '利益額', '利益計算', '売値', '原価率', '利益率', 'food cost', 'フードコスト'],
    ['合成レシピ 保存一覧', '保存済み 合成', '合成 一覧', '合成 編集', '合成 削除', '保存済み合成レシピ'],
...
const ENTRY_INTENT_BOOSTS = {
    ...
    composite_cost_profit: ['コスト率', '利益', '利益額', '利益計算', '売値', '原価率', 'フードコスト', 'food cost', '赤', 'コスト率 高い'],
