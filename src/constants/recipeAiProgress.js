...
const PROGRESS_CONFIGS = {
    'product-generate': {
        ...
        steps: [
            ...
            { label: 'レシピ統合', provider: 'Groq Llama 3.3 70B', description: '調査結果を配合と工程へ整理' },
            { label: '食品科学検証', provider: 'Groq Llama 3.3 70B', description: '食感・火入れ・保存性の理屈を確認' },
            { label: '科学・安全性検証', provider: 'Groq Compound', description: '再現性と安全性を確認' },
            { label: '統合ドラフト', provider: 'OpenAI gpt-4.1-mini', description: '専門家の所見を商品レシピへ統合' },
            { label: '反証レビュー', provider: 'OpenAI o4-mini', description: '見落としや矛盾、失敗しやすい点を批判的に検証' },
            { label: '最終修正', provider: 'OpenAI gpt-4.1-mini', description: '反証結果を反映した完成案を作成' },
        ],
    },
    'product-conversation': {
        ...
        steps: [
            ...
            { label: 'レシピ統合', provider: 'Groq Llama 3.3 70B', description: '現在案の見直し点を整理' },
            { label: '食品科学検証', provider: 'Groq Llama 3.3 70B', description: '工程と食感への影響を確認' },
            { label: '科学・安全性検証', provider: 'Groq Compound', description: '回答内容の再現性と安全性を確認' },
            { label: '最終クロスチェック', provider: 'OpenAI o4-mini', description: '回答案を批判的に査読' },
            { label: '回答・更新案の統合', provider: 'OpenAI gpt-4.1-mini', description: '会話回答とレシピ更新案をまとめる' },
        ],
    },
    'improvement-generate': {
        ...
        steps: [
            ...
            { label: 'レシピ統合', provider: 'Groq Llama 3.3 70B', description: '材料構成と改善方針を整理' },
            { label: '食品科学検証', provider: 'Groq Llama 3.3 70B', description: '工程の妥当性と食感への影響を確認' },
            { label: '科学・安全性検証', provider: 'Groq Compound', description: '温度・衛生・再現性を確認' },
            { label: '最終クロスチェック', provider: 'OpenAI o4-mini', description: '改善案の矛盾や実務上の懸念を査読' },
            { label: '改善案の統合', provider: 'OpenAI gpt-4.1-mini', description: '各所見を保存可能な改善案へ統合' },
            { label: '反証レビュー', provider: 'OpenAI o4-mini', description: '完成案の弱点を批判的に検証' },
            { label: '最終修正', provider: 'OpenAI gpt-4.1-mini', description: '反証結果を反映して完成' },
        ],
    },
    'improvement-conversation': {
        ...
        steps: [
            ...
            { label: 'レシピ統合', provider: 'Groq Llama 3.3 70B', description: '材料・工程の見直し点を整理' },
            { label: '食品科学検証', provider: 'Groq Llama 3.3 70B', description: '食感と安定性への影響を確認' },
            { label: '科学・安全性検証', provider: 'Groq Compound', description: '温度・衛生・再現性を確認' },
            { label: '最終クロスチェック', provider: 'OpenAI o4-mini', description: '回答案を批判的に査読' },
            { label: '回答・更新案の統合', provider: 'OpenAI gpt-4.1-mini', description: '会話回答と更新内容をまとめる' },
        ],
    },
};
