        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            ...
            <div className="incoming-stock__calc-grid">
              <button className="incoming-stock__calc-btn" onClick={() => addToConsumeAmount(0.001)}>+0.001</button>
              <button className="incoming-stock__calc-btn" onClick={() => addToConsumeAmount(0.01)}>+0.01</button>
